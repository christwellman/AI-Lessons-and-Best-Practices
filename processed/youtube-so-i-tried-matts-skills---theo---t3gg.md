...
source_type: "youtube"
source_url: "https://www.youtube.com/watch?v=0oXOOlqVu5M"
author: "Theo - t3․gg"
published: ""
ingested: "2026-08-23"
category: "skills"
tags: [ai-skills, markdown-prompts, cursor-workflow, agent-management]
summary: "Engineers build custom AI skills using simple markdown files. Developers audit existing skill suites from Matt Pocock and Lauren Porter to select relevant tools. The unslop skill removes AI writing patterns and produces human-sounding text. Users test skills directly by copying text into agents before installation."
...
Engineers build custom AI skills using simple markdown files. Developers audit existing skill suites from Matt Pocock and Lauren Porter to select relevant tools. The unslop skill removes AI writing patterns and produces human-sounding text. Users test skills directly by copying text into agents before installation.

## Key Takeaways

- Do not blindly copy entire skill repositories into your environment.
- Treat skill descriptions as triggers that tell the model when to pull the skill into context.
- Use the unslop skill to remove AI filler phrases and make agent text direct and readable.
- Test text-based skills quickly by copying the markdown content directly into your active coding agent.
- Maintain a dedicated fleet repository to manage and organize your custom skill files across multiple machines.

## Techniques / Prompts Extracted

- Edit text to remove AI patterns and add a human voice. The process is simple. Scan for the patterns, rewrite, preserve meaning, match intended tone, add some soul, and then self audit.
- Grill the user relentlessly about a plan, decision, or idea. Use when the user wants to stress test their thinking or use any grill trigger phrases. Interview the user relentlessly until you reach a shared understanding. Map this as a design tree. Every decision branches into the decisions that hang off it. Work the tree in rounds. The frontier is every decision whose prerexs are already settled.
